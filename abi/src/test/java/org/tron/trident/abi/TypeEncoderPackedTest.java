...
public class TypeEncoderPackedTest {
  ...
  public void testPrimitiveIntEncodePacked() {
    assertEquals(
        "00000000", TypeEncoder.encodePacked(new org.tron.trident.abi.datatypes.primitive.Int(0)));

    assertEquals(
        "80000000",
        TypeEncoder.encodePacked(
            new org.tron.trident.abi.datatypes.primitive.Int(Integer.MIN_VALUE)));

    assertEquals(
        "7fffffff",
        TypeEncoder.encodePacked(
            new org.tron.trident.abi.datatypes.primitive.Int(Integer.MAX_VALUE)));
  }
  ...
  public void testPrimitiveFloatEncodePacked() {
    assertThrows(
        UnsupportedOperationException.class,
        () -> TypeEncoder.encodePacked(new org.tron.trident.abi.datatypes.primitive.Float(0)));
  }

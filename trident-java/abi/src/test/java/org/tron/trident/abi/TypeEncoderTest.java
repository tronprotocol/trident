...
public class TypeEncoderTest {
    ...
    public void testIntEncode() {
        ...
        org.tron.trident.abi.datatypes.Int max64 = new Int64(BigInteger.valueOf(java.lang.Long.MAX_VALUE));
        assertEquals(
                TypeEncoder.encodeNumeric(max64),
                ("0000000000000000000000000000000000000000000000007fffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min64 = new Int64(BigInteger.valueOf(java.lang.Long.MIN_VALUE));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max80 = new Int80(new BigInteger("604462909807314587353087"));
        assertEquals(
                TypeEncoder.encodeNumeric(max80),
                ("000000000000000000000000000000000000000000007fffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min80 = new Int80(new BigInteger("-604462909807314587353088"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max88 = new Int88(new BigInteger("154742504910672534362390527"));
        assertEquals(
                TypeEncoder.encodeNumeric(max88),
                ("0000000000000000000000000000000000000000007fffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min88 = new Int88(new BigInteger("-154742504910672534362390528"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max96 = new Int96(new BigInteger("39614081257132168796771975167"));
        assertEquals(
                TypeEncoder.encodeNumeric(max96),
                ("00000000000000000000000000000000000000007fffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min96 = new Int96(new BigInteger("-39614081257132168796771975168"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max104 = new Int104(new BigInteger("10141204801825835211973625643007"));
        assertEquals(
                TypeEncoder.encodeNumeric(max104),
                ("000000000000000000000000000000000000007fffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min104 = new Int104(new BigInteger("-10141204801825835211973625643008"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max112 = new Int112(new BigInteger("2596148429267413814265248164610047"));
        assertEquals(
                TypeEncoder.encodeNumeric(max112),
                ("0000000000000000000000000000000000007fffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min112 = new Int112(new BigInteger("-2596148429267413814265248164610048"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max120 = new Int120(new BigInteger("664613997892457936451903530140172287"));
        assertEquals(
                TypeEncoder.encodeNumeric(max120),
                ("00000000000000000000000000000000007fffffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min120 = new Int120(new BigInteger("-664613997892457936451903530140172288"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max128 = new Int128(new BigInteger("170141183460469231731687303715884105727"));
        assertEquals(
                TypeEncoder.encodeNumeric(max128),
                ("000000000000000000000000000000007fffffffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min128 = new Int128(new BigInteger("-170141183460469231731687303715884105728"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max136 = new Int136(new BigInteger("43556142965880123323311949751266331066367"));
        assertEquals(
                TypeEncoder.encodeNumeric(max136),
                ("0000000000000000000000000000007fffffffffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min136 = new Int136(new BigInteger("-43556142965880123323311949751266331066368"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max144 = new Int144(new BigInteger("11150372599265311570767859136324180752990207"));
        assertEquals(
                TypeEncoder.encodeNumeric(max144),
                ("00000000000000000000000000007fffffffffffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min144 = new Int144(new BigInteger("-11150372599265311570767859136324180752990208"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max152 = new Int152(new BigInteger("2854495385411919762116571938898990272765493247"));
        assertEquals(
                TypeEncoder.encodeNumeric(max152),
                ("000000000000000000000000007fffffffffffffffffffffffffffffffffffff"));

        org.tron.trident.abi.datatypes.Int min152 = new Int152(new BigInteger("-2854495385411919762116571938898990272765493248"));
        assertEquals(
        ...
        org.tron.trident.abi.datatypes.Int max160 = new Int160(new BigInteger("730750818665451459101842416358141509827966271487"));
        assertEquals(
                TypeEncoder.encodeNumeric(max160),
        ...
        org.tron.trident.abi.datatypes.Int minusOne = new org.tron.trident.abi.datatypes.Int(BigInteger.valueOf(-1));
        assertEquals(
